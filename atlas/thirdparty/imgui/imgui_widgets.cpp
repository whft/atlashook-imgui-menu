...
bool ImGui::CloseButton(ImGuiID id, const ImVec2& pos)
{
    ...
    // Render - Simple 'x' as per the image
    float cross_extent = g.FontSize * 0.3f; 
    ImU32 cross_col = hovered ? IM_COL32(255, 255, 255, 255) : IM_COL32(150, 150, 150, 255);
    if (held) cross_col = IM_COL32(200, 200, 200, 255);
